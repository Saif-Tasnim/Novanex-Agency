...
const SingleCard = ({ title, description, link}) => {
    return (
        <div className="w-full p-10 border shadow-md shadow-green-200">
            ...
            <Link to={link} className="pt-5 flex gap-2 items-center text-green-600 text-xl"> Learn More <span className="pt-1 text-green-600"><Icons.MoveRightIcon /></span> </Link>
        </div>
    );
};
